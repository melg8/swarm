...
const VARIANTS = [
  {
    ...
    note: "as on the map today: the number pops up and fades, the crit is larger and labeled",
    swingLife: 0.55,
    damageLife: 1.15,
  ...
  },
  {
    num: "02",
    name: "Comic pop",
    note: "hit star plus a lunging number, the crit shakes the whole cell",
    swingLife: 0.5,
    damageLife: 1.0,
    swing(ctx, v, ev, p) {
  ...
  },
  {
    num: "03",
    name: "Slash",
    note: "a white slash across the target, the crit is a cross of two slashes",
    swingLife: 0.5,
    damageLife: 1.05,
    swing(ctx, v, ev, p) {
  ...
  },
  {
    num: "04",
    name: "Spark spray",
    note: "sparks fly from the target toward the hit, the crit is a golden sheaf",
    swingLife: 0.5,
    damageLife: 1.0,
  ...
  },
  {
    num: "05",
    name: "Shockwave",
    note: "a shock wave spreads in rings, the crit is three rings",
    swingLife: 0.5,
    damageLife: 1.2,
  ...
  },
  {
    num: "06",
    name: "HP bar chunk",
    note: "the damage breaks off a piece of the HP bar and falls, the crit is a golden piece",
    swingLife: 0.5,
    swing: fightDefaultSwing,
    damageLife: 1.25,
    damage(ctx, v, ev, p) {
...
VARIANTS.push(
  {
    num: "07",
    name: "Arrow",
    note: "the hit is a flying arrow, the crit is a fiery arrow with a trail",
    swingLife: 0.6,
    damageLife: 0.9,
    swing(ctx, v, ev, p) {
      const from = ev.byHero ? v.hero : v.enemy;
  ...
  },
  {
    num: "08",
    name: "Hit-stop",
    note: "cinematic: a freeze frame with a camera push in, the crit lasts longer and flashes",
    swingLife: 0.5,
    swing: fightDefaultSwing,
    damageLife: 1.3,
    damage(ctx, v, ev, p) {
  ...
  },
  {
    num: "10",
    name: "Dizzy stars",
    note: "little stars circle over the hurt one, the crit is five golden ones",
    swingLife: 0.5,
    swing: fightDefaultSwing,
    damageLife: 1.5,
    damage(ctx, v, ev, p) {
  ...
  },
  {
    num: "11",
    name: "Arcade banner",
    note: "a banner above the cell: HIT / CRITICAL, sliding in like in an arcade",
    swingLife: 0.5,
    swing: fightDefaultSwing,
    damageLife: 1.3,
    damage(ctx, v, ev, p) {
  ...
  },
  {
    num: "12",
    name: "Combo counter",
    note: "a combo counter, the numbers roll in from below, the crit in gold",
    swingLife: 0.5,
    swing: fightDefaultSwing,
    damageLife: 1.2,
    damage(ctx, v, ev, p) {
