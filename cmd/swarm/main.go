...
// file renders in first-seen order. The -from/-to window bounds the
// records folded into the aggregates (the time-boxed report of one
// interesting stretch of a long session).
